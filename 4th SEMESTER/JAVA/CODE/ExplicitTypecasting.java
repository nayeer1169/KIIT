public class  ExplicitTypecasting{
    public static void main(String[] args){
        ...
        //Explicit way for coverting long to int
       // i = (int)l;
//if data type value if like
        l=12345678911L; //it will throw an error
        i = (int)l;
        System.out.println(l);
        System.out.println(i);  //  simple way as done in last program
